...
![консоль](image/4.png){ #fig:004 width=90% }

5. Создал GPG ключ

![гитхаб](image/5.png){ #fig:005 width=90% }

6. Отправил отчёты с помощью GPG ключа. 

![гитхаб](image/6.png){ #fig:006 width=90% }
...
периодически
(по специальной команде администратора) выполняется сохранение версий всех файлов в полном виде; такой подход обеспечивает максимально полное восстановление истории в случае повреждения репозитория.
...
merge URL.
9. Что
такое и зачем могут быть нужны ветви (branches)?
